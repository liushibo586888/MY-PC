    ...
    <div class="jyshD-container container">
        <div>
            <Tabs value="name1" @on-click="tabChangejyshD">
                ...
                <TabPane label="新客成交项目分类占比" icon="dot" name="name12">
                    <keep-alive>
                ...
                <TabPane label="项目客单价" icon="dot" name="name13">
                    <keep-alive>
                ...
                <TabPane label="顾客分类占比" icon="dot" name="name14">
                    <keep-alive>
                        <template v-if="tabIndex1=='name14'">
                            <yjje13-demo :startDate="startDate" :endDate="endDate" :storeID="storeID"></yjje13-demo>
                        </template>
                    </keep-alive>
                </TabPane>
            </Tabs>
                ...
                <row :gutter="20">
                    ...
                    <i-col span="3">
                        <FormItem prop="timeList">
                            <Select v-model="formItem.month" placeholder="时间" :filterable="true" :label-in-value="true" @on-change="changeTimeD">
...
import yjje13Demo from "../reportCenter/jyshDchilddren/yjjeGKFLZB";
  ...
  methods: {
    changeTimeD(val) {
      ...
      if (val.label == "上月") {
        ...
        that.formItem.startDate = year1 + "-" + month1 + "-" + "01";
        that.formItem.endDate = year1 + "-" + month1 + "-" + day2;
      }
      if (val.label == "本月") {
        that.formItem.startDate = year1 + month1 + "01";
        that.formItem.endDate = year1 + month1 + day;
