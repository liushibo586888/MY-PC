<template>
  <div class="jyshD-container container">
    ...
    <div class="form-box">
      <div class="charts">
        <!-- <div class="jyshD_btnList">
          <button class="button">新客项目分类业绩占比</button>
          <button class="button">跟踪客项目分类业绩占比</button>
          <button class="button">护理客项目分类业绩占比</button>
        </div> -->
        <div class="header">
          新客项目分类业绩占比
        </div>
  ...
  methods: {
    ...
    getList() {
      setTimeout(() => {
        ...
        that.spinShow = true;
        api.getCustomerItemCategoryAllTotal(data).then(response => {
