<template>
  <div class="jyshD-container container">
    ...
    <!-- <div class="table-box" id="tableBox">
      <Table :columns="columns" :data="NameList" highlight-row height="300" ref="mainTable"></Table>
  ...
  methods: {
    ...
    setPieData() {
      ...
      for (let i in that.NameList) {
        // 饼图
        let a = {
          value: that.NameList[i].Value - that.NameList[i].ValueTow,
          name:
            that.NameList[i].Name +
            "(" +
            (that.NameList[i].Value - that.NameList[i].ValueTow) +
            ")" +" "+
