<template>
  <div class="container">
        ...
        <row :gutter="20">
          <!-- <i-col span="3">
            <formItem prop="StartDate">
              <DatePicker type="month" class="DatePicker_time" :options="options1" placeholder="开始日期" v-model="formItem.StartDate" :clearable="false" :editable="false"></DatePicker>
            </formItem>
          </i-col>
          <i-col span="3">
            <formItem prop="EndDate">
              <DatePicker type="month" class="DatePicker_time" :options="options1" placeholder="结束日期" v-model="formItem.EndDate" :clearable="false" :editable="false"></DatePicker>
            </formItem>
          </i-col> -->
          <i-col span="3">
            <FormItem prop="store">
    ...
    <div class="table-box gundong" id="tableBox">
