    ...
    return {
      ...
      columns1: [
        ...
        },
        {
          ...
          width: 180,
          render: (h, params) => {
            return echartsCommon.ToolTip(h, params.row.StoreName, 8);
          }
        },
        {
          title: "渠道咨询",
        ...
        },
        {
          ...
          width: 150,
          render: (h, params) => {
            return echartsCommon.ToolTip(h, params.row.ItemTopCategoryName, 6);
          }
        },
        {
          title: "项目分类",
        ...
        },
        {
          ...
          width: 230,
          render: (h, params) => {
            return echartsCommon.ToolTip(h, params.row.ItemName, 12);
          }
        },
        {
          title: "规格",
          ...
          width: 120,
          render: (h, params) => {
            return echartsCommon.ToolTip(h, params.row.ItemStandard, 5);
          }
        },
        {
          title: "单位",
