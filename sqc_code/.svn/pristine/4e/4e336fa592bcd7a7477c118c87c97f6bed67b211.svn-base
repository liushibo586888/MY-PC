...
<template>
  <div class="main" :class="{'main-hide-text': shrink}">
      ...
      <div class="main-header">
        <div class="store-message">
          <Breadcrumb separator="/">
            <BreadcrumbItem v-for="(tm,index) in breadcrumblist" :key="index">{{tm.title}}</BreadcrumbItem>
          </Breadcrumb>
        </div>
        ...
        <div class="store-message">
          ...
          <div class="user-message" v-if="userMes && userMes.PositionName">
            ...
            <div class="dropMessage" @mouseenter="isShowTips=true" :class="[isShowTips? 'checked' : '']">
              <!-- <i class="ivu-icon ivu-icon-aaa-shezhi"></i> @click.native="isShowTips = !isShowTips"-->
              <Icon type="ios-gear-outline" @click.native="isShowTips = !isShowTips" style="font-size: 30px"></Icon>
              <ul v-show="isShowTips == true">
                <!-- <li>  </li> -->
                <li @click="changePassword" style="list-style: none;">修改信息</li>
                <li @click="loginOff" style="list-style: none;">退出</li>
              </ul>
            </div>
    ...
    <!-- 抽屉样式
   <Drawer title="Basic Drawer" :closable="false" v-model="modal1">
        <p>Some contents...</p>
        <p>Some contents...</p>
        <p>Some contents...</p>
    </Drawer>-->
