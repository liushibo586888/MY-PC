          ...
          <row :gutter="20">
            ...
            <i-col span="3">
              <FormItem prop="typeID">
                <Select v-model="formItem.typeID" placeholder="类别" :filterable="true">
    ...
    return {
      ...
      columns1: [
        ...
        },
        {
          ...
          align: "center",
          render: (h, params) => {
            return echartsCommon.DATEsfm(h, params.row.dateTime);
          }
        },
        {
          title: " ",
  ...
  methods: {
    ...
    getList() {
      setTimeout(() => {
        let that = this;
        let data = {
          custid: that.$route.query.ID,
          type: that.formItem.typeID,
        ...
        api.ConsumptionSumDetails(data).then(res => {
          if (res.error_code === "Success") {
            that.list = res.data.AsumDetails;
